    ...
    if uploaded_file is not None:
        ...
        if st.button("Submit"):
            ...
            suggestions = {
                ...
                "1st stage Compression failure or 1st Stage Leakage Issue": (
                    "Recommend checking the flash sequence of the 1st stage to confirm any compressor-related issues or performing a leak test on the 1st stage to eliminate the possibility of leakage, particularly near the condenser inlet and outlet braze joints. Request them to report back the leak location to US."
                ),
                "2nd stage compression failure": (
